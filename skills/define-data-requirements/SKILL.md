...
# Description
Define data inputs, outputs, quality, governance, and lifecycle requirements.

# When To Use
Use this skill when planning or delivering tasks under the Requirements Engineering domain.
...
# Outputs
- Structured output tailored to DefineDataRequirements.
