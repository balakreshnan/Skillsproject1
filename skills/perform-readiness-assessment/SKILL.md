---
name: perform-readiness-assessment
version: 0.1.0
owner: platform-team
status: active
tags:
...
# Description
Perform readiness assessment across process, technology, and operations.
...
# Outputs
- Structured output tailored to PerformReadinessAssessment.
