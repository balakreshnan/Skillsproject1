...
# Description
Define and frame a concrete use case with clear scope, actors, and expected outcomes.

# When To Use
Use this skill when planning or delivering tasks under the Use Case Strategy domain.
...
# Outputs
- Structured output tailored to DefineUseCase.
