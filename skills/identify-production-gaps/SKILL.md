...
# Description
Identify production readiness gaps across security, reliability, and operations.

# When To Use
Use this skill when planning or delivering tasks under the Architecture and Design domain.
...
# Outputs
- Structured output tailored to IdentifyProductionGaps.
